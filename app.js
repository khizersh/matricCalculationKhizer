...
function rowcol() {                                 //checking the number of rows and columns
    ...
    if (row1 < 2 || col1 < 2 || row1 > 5 || col1 > 5) {
        ...
        okbutton.setAttribute("class", "btn btn-dark sizing")
...
function setmatrices() {                                        //saving elements of matrix in array and showing operations
    ...
    options.innerHTML = '<button class="btn btn-dark mt-1" onclick="deter()">Find Determinent</button><br><button class="btn btn-dark mt-1" onclick="transpose()">Find Transpose</button><br><button class="btn btn-dark mt-1" onclick="inverse()">Find Inverse</button><br><button class="btn btn-dark mt-1" onclick="addscalor()">Add Scalor</button><br><button class="btn btn-dark mt-1" onclick="multiplyscalor()">Multiply a scalor</button><br>'
...
//***********************// INNPUT FIELDS FOR FIRST MATRIX
        for (let i = 1; i <= row1; i++) {                     
...
function setmatrices2() {
    ...
    var options = document.createElement('p')
    options.innerHTML = '<button class="btn btn-dark mt-1 mt-1" onclick="mulmat1mat2()">Multiply the first matrix with the second</button><br><button class="btn btn-dark mt-1" onclick="mulmat2mat1()">Multiply the second matrix with first</button><br><button class="btn btn-dark mt-1" onclick="addmat1mat2()">Add both matrices</button><br><button class="btn btn-dark mt-1" onclick="submat2mat1()">Subtract the first matrix from second</button><br><button class="btn btn-dark mt-1" onclick="submat1mat2()">Subtract the second matrix from the first</button><br>'
    document.getElementById('matopr').appendChild(options)
}
